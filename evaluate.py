...
model = AutoModelForSeq2SeqLM.from_pretrained(
    "/home/ubuntu/mt5-custom-prompt-dataset/pt-test-prompted-germanquad-2/checkpoint-104973"
)
...
eval_result = trainer.evaluate(eval_dataset=processed_dataset["test"])
...
trainer.create_model_card(model_name="test-german-t5-prompted-germanquad")
